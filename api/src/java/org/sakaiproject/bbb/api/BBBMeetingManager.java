...
public interface BBBMeetingManager {
    ...
    public static final String FN_RECORDING_DOWNLOAD = "bbb.recording.download";
    public static final List<String> FUNCTIONS = Arrays.asList(new String[] { FN_CREATE,
            ...
            FN_RECORDING_EXTENDEDFORMATS_OWN, FN_RECORDING_EXTENDEDFORMATS_ANY, FN_RECORDING_DOWNLOAD });
